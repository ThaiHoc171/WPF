...
public partial class CaKhamTrongPage : Page, INotifyPropertyChanged
{
	...
	private void SetupColumns()
	{
		...
		GridContent.Columns.Add(
			SetupDataGrid.CreateIconButtonColumn("AccountPlus", Register_Click, "Đăng ký"));
	}
	...
	private async Task LoadData()
	{
		try
		{
			...
			var res = await _client.GetPaged(ngay,"Trống",loai,	Page,SizePage);
